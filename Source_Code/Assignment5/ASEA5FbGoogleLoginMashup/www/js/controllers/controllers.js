...
oauthApp.controller('welcomeCtrl', function ($scope, $state, $cookieStore) {
    ...
    $scope.gplusLogin = function () {
        var myParams = {
            ...
            'clientid': '439020958244-vk4nt1efabupis6l73r4gksiqpo58k01.apps.googleusercontent.com',
...
// Mashup Controller
oauthApp.controller('gmapsFlickrMashupCtrl', function ($scope, $window, $state, $cookieStore) {
    // Set user details
    $scope.user = $cookieStore.get('userInfo');

    // redirect user
    $scope.gmapsFlickrMashup = function () {

       // $state.go('gmapsFlickrMashup');
        $window.location.href = './gmapsFlickrMashup.html'
